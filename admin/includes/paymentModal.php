            ...
            <div class="modal-body ">
                <form action="payment_edit.php" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <label for="btype">Purpose of Payment: </label>
                            </div>
                            <div class="col">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Deleting Payment</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="payment_delete.php" method="POST">
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" name="id" class="id">
                        <h6 class="text-black text-left">Resident Name: </h6>
                        <p id="del_resident" class="text-center"></p>
                        <h6 class="text-black text-left">Purpose of payment: </h6>
                        <p id="del_purpose" class="text-center"></p>
                    </div>
